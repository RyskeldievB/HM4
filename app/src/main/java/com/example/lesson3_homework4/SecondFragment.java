package com.example.lesson3_homework4;
...
import com.example.lesson3_homework4.databinding.FragmentSecondBinding;
...
public class SecondFragment extends Fragment {
    ...
    private void loadData() {
        ...
        switch (continent) {
            case 1:
                country.add(new Country("Кыргызстан", "Бишкек", R.drawable.ic_kg, 1));
            ...
            case 5:
                ...
                break;
            case 6:
                Toast.makeText(requireActivity(), "Жок Эчтеке", Toast.LENGTH_SHORT).show();
                break;
        }
    }
